...
<span style="border: 1.5px solid #7b1fa2; border-radius: 50px; padding: 4px 12px; background-color: white; color: #7b1fa2; font-size: 0.85em; margin-left: 8px;">Email: open.qiancx[at]gmail.com</span>
<span style="border: 1.5px solid #7b1fa2; border-radius: 50px; padding: 4px 12px; background-color: white; color: #7b1fa2; font-size: 0.85em; margin-left: 4px;">WeChat: qiancxdotcom</span>
</div>
